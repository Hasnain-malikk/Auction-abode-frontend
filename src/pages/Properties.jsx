...
const Properties = () => {
  ...
  useEffect(() => {
    if (!user) {
      ...
      if (user.role === "Seller") {
        fetchPropertiesbyid(); // Only show Seller's own properties
      } else {
        fetchProperties(); // Show all properties for Buyer
      }
    }
  }, [user, navigate]);
console.warn(user)
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        ...
                        <LoadScript googleMapsApiKey="AIzaSyDU5rN_CouJHC7nKBt7ll6dpWgD8RtH-i0">
                          <GoogleMap
